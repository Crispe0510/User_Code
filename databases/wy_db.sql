...
CREATE TABLE `admin_user`  (
  ...
  `password` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '密码(明文演示)',
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '显示名',
  `role` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'admin' COMMENT 'super/admin',
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1启用 0禁用',
  `last_login` datetime NULL DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `username`(`username`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '后台管理员' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of admin_user
-- ----------------------------
INSERT INTO `admin_user` VALUES (1, 'admin', 'admin123', 'Super Admin', 'super', 1, '2026-04-25 20:08:59', '2026-04-20 14:27:25');
INSERT INTO `admin_user` VALUES (2, 'editor', 'editor123', 'Content Editor', 'admin', 1, NULL, '2026-04-20 14:27:25');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '自定义问题' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '自定义场景' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '自定义话题' ROW_FORMAT = Dynamic;
...
CREATE TABLE `family_member`  (
  ...
  `user_id` bigint(20) NOT NULL COMMENT '所属H5用户',
  ...
  `sort_order` int(11) NULL DEFAULT 0,
  `linked_user_id` bigint(20) NULL DEFAULT NULL COMMENT '关联的 H5 账号 ID，关联后双方共享聊天室',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '家庭成员' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of family_member
-- ----------------------------
INSERT INTO `family_member` VALUES ('m1', 1, 'Grandpa', 'parent', '👴', 1, NULL);
INSERT INTO `family_member` VALUES ('m1063e7', 5, '123', 'parent', '👤', 1, 2);
INSERT INTO `family_member` VALUES ('m2', 1, 'Mom', 'parent', '👩', 2, NULL);
INSERT INTO `family_member` VALUES ('m3', 1, 'Me (You)', 'child', '🧒', 3, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'H5用户' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '心情打卡' ROW_FORMAT = Dynamic;
...
CREATE TABLE `mood_type`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '心情类型' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of mood_type
-- ----------------------------
INSERT INTO `mood_type` VALUES ('anxious', '😟', 'A Bit Worried', '#CFD8DC', 'Be gentle. Listen more, speak less. Just knowing you\'re there helps.');
INSERT INTO `mood_type` VALUES ('excited', '🎉', 'Excited', '#FFE0B2', 'Match their energy! Ask what\'s got them excited and celebrate together.');
INSERT INTO `mood_type` VALUES ('grateful', '🥰', 'Grateful', '#FCE4EC', 'They\'re feeling appreciative. Share something you\'re thankful for too.');
INSERT INTO `mood_type` VALUES ('happy', '😊', 'Happy', '#FFF9C4', 'Great time to share what made them smile — ask about the highlight of their day!');
INSERT INTO `mood_type` VALUES ('peaceful', '😌', 'Peaceful', '#B2EBF2', 'They\'re in a calm state. Perfect for a gentle, relaxed chat.');
INSERT INTO `mood_type` VALUES ('tired', '😴', 'Tired', '#D1C4E9', 'Give them space. A simple \"I\'m here\" or a quiet moment together goes a long way.');
...
CREATE TABLE `report_timeline`  (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '报告时间线' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of report_timeline
-- ----------------------------
INSERT INTO `report_timeline` VALUES ('r1', 1, '12 Apr 2026', 'Home · Dinner', 'Topic explored: Taste of Childhood', 'Completed 3 of 4 opening questions with a grandparent.', 'topic', 1, '2026-04-20 14:27:26');
...
CREATE TABLE `scenario`  (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '场景' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of scenario
-- ----------------------------
INSERT INTO `scenario` VALUES ('cat-events', 'Events & Experiences', 'Relive and share life experiences together', '🎯', 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80', 23, 10, 1, '2026-04-20 14:27:25');
INSERT INTO `scenario` VALUES ('cat-object', 'Objects & Interests', 'Share stories behind things that matter', '📦', 'https://images.unsplash.com/photo-1516483638261-f4dbaf036963?w=800&q=80', 16, 9, 1, '2026-04-20 14:27:25');
INSERT INTO `scenario` VALUES ('cat-people', 'People & Relationships', 'Discuss inspiring people in your lives', '👥', 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=800&q=80', 10, 7, 1, '2026-04-20 14:27:25');
INSERT INTO `scenario` VALUES ('cat-place', 'Places & Occasions', 'Explore memorable places and moments', '🗺', 'https://images.unsplash.com/photo-1501854140801-50d01698950b?w=800&q=80', 4, 8, 1, '2026-04-20 14:27:25');
INSERT INTO `scenario` VALUES ('s1', 'Mealtime Together', 'Stories over shared food', '🍽', 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800&q=80', 3, 1, 1, '2026-04-20 14:27:25');
INSERT INTO `scenario` VALUES ('s2', 'Watching TV / Videos', 'Connecting through shows', '📺', 'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=800&q=80', 3, 2, 1, '2026-04-20 14:27:25');
INSERT INTO `scenario` VALUES ('s3', 'Walking Outdoors', 'Conversations on the move', '🌿', 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&q=80', 3, 3, 1, '2026-04-20 14:27:25');
INSERT INTO `scenario` VALUES ('s4', 'Car Rides & Travel', 'Stories from the journey', '🚗', 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=800&q=80', 3, 4, 1, '2026-04-20 14:27:25');
INSERT INTO `scenario` VALUES ('s5', 'Cooking & Chores', 'Bonding through daily tasks', '🍳', 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=800&q=80', 3, 5, 1, '2026-04-20 14:27:25');
INSERT INTO `scenario` VALUES ('s6', 'Resting at Home', 'Quiet moments together', '🏠', 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&q=80', 3, 6, 1, '2026-04-20 14:27:25');
...
-- Records of topic
-- ----------------------------
INSERT INTO `topic` VALUES ('ev-apology', 'cat-events', 'When Someone Apologised', 'Describe a time when someone apologised to you', 'Apologies are cultural and deeply personal — exploring how different generations handle \"sorry\" opens up rich emotional conversation.', 16, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-bad-concert', 'cat-events', 'A Music Event You Didn\'t Enjoy', 'Describe a music event that you didn\'t enjoy', 'Disagreements about music are fun and harmless — this topic leads to lively generational debates about taste.', 21, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-broke-something', 'cat-events', 'When You Broke Something', 'Describe a time when you broke something', 'Oops moments are universally relatable — comparing how generations handle breakage and repairs sparks laughter and wisdom.', 2, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-decision', 'cat-events', 'A Decision Made Together', 'Describe an important decision made with help from others', 'Decision-making is deeply personal yet shaped by community — sharing experiences reveals how generations approach life choices differently.', 3, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-exciting-first', 'cat-events', 'An Exciting First', 'Describe an exciting activity you tried for the first time', 'First-time experiences are unforgettable — sharing them sparks enthusiasm and builds connections across generations.', 6, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-family-dinner', 'cat-events', 'A Special Family Dinner', 'Describe a great dinner you enjoyed with friends or family', 'Family meals are at the heart of Chinese culture — this topic naturally bridges generations through food and togetherness.', 17, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-foreign-language', 'cat-events', 'Speaking a Foreign Language', 'Describe the first time you talked in a foreign language', 'Language learning experiences vary hugely across generations — sharing them reveals both the challenges and joys of communication.', 14, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-gave-advice', 'cat-events', 'When You Gave Advice', 'Describe a time when you gave advice to others', 'Advice-giving is a powerful act of trust — discussing when and how to give advice bridges generational wisdom beautifully.', 4, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-good-service', 'cat-events', 'Great Service', 'Describe a time when you received good service in a shop', 'Service experiences reflect social norms that have shifted dramatically across generations — a rich topic for storytelling.', 8, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-imagination', 'cat-events', 'When You Used Your Imagination', 'Describe a time you needed to use your imagination', 'Imagination is the root of creativity — comparing how different generations express and value imagination is always illuminating.', 23, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-long-journey', 'cat-events', 'A Long Journey', 'Describe a long journey you had and would like to take again', 'Travel stories are among the richest shared experiences — revisiting journeys reveals how they shaped us.', 1, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-lost-way', 'cat-events', 'Getting Lost', 'Describe an occasion when you lost your way', 'Getting lost is both stressful and memorable — comparing how different generations navigated (literally and metaphorically) is fascinating.', 15, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-movie', 'cat-events', 'A Film You Enjoyed', 'Describe a movie you watched and enjoyed recently', 'Movies are a universal language — comparing films across generations opens up rich conversations about values, heroes and culture.', 22, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-positive-change', 'cat-events', 'A Positive Change', 'Describe a positive change you made recently in your daily routine', 'Change and growth are lifelong processes — comparing how we evolve resonates deeply across all ages.', 7, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-power-cut', 'cat-events', 'When the Lights Went Out', 'Describe a time when the electricity suddenly went off', 'Power cuts are memorable events — comparing reactions across generations reveals how much (or little) we rely on electricity.', 5, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-proud-family', 'cat-events', 'Proud of a Family Member', 'Describe a time when you felt proud of a family member', 'Pride in family is universal and deeply meaningful — sharing these moments builds connection and affirms what we value most.', 19, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-social-media', 'cat-events', 'Something Interesting on Social Media', 'Describe a time you saw something interesting on social media', 'Social media is a generational dividing line — comparing experiences of it can be both enlightening and entertaining.', 12, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-speech', 'cat-events', 'A Speech You Gave', 'Describe a talk you gave to a group of people', 'Public speaking is a universal challenge — comparing how we communicate across generations uncovers shared vulnerabilities and growth.', 9, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-story-read', 'cat-events', 'A Story You Read Recently', 'Describe a story (fairy tale, etc.) you have read recently', 'Stories and storytelling are timeless — comparing the stories that shaped each generation is both revealing and touching.', 18, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-told-truth', 'cat-events', 'Telling an Important Truth', 'Describe a time when you told your friend an important truth', 'Honesty is a core value that generations sometimes define differently — this topic opens meaningful conversations about trust.', 13, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-unusual-meal', 'cat-events', 'An Unusual Meal', 'Describe an unusual meal you had', 'Food adventures connect us to culture and memory — sharing unusual meals often leads to funny and vivid stories.', 10, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-vehicle-trip', 'cat-events', 'A Vehicle Trip', 'Describe a bicycle / motorcycle / car trip you would like to go on', 'Road trips and vehicle journeys hold memories for every generation — this topic sparks stories of freedom, adventure and change.', 20, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ev-waiting', 'cat-events', 'Waiting for Something Special', 'Describe a time when you waited for something important', 'Patience and anticipation mean different things to different generations — this topic opens up conversations about values and expectations.', 11, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-app', 'cat-object', 'A Favourite App', 'Describe an app or program you use on your phone or computer', 'Apps are a generational dividing line — comparing how different family members use technology sparks lively and fun discussion.', 14, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-book', 'cat-object', 'A Useful Book', 'Describe a book you read that you found useful', 'Books have shaped every generation differently — sharing favourite reads opens wonderful conversations about knowledge and wisdom.', 3, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-building', 'cat-object', 'An Interesting Building', 'Describe an interesting building you saw during a trip', 'Architecture and travel connect personal history to culture — sharing discoveries from travels is naturally engaging across ages.', 9, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-dream-job', 'cat-object', 'Your Dream Job', 'Describe your perfect job', 'Career aspirations reveal generational shifts in values — comparing dreams across ages opens honest and meaningful conversations.', 12, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-family-thing', 'cat-object', 'Something Important to the Family', 'Describe something important your family has kept for a long time', 'Family treasures carry emotional weight — sharing their stories is a beautiful way to pass down family history.', 15, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-habit', 'cat-object', 'A Good Habit from a Friend', 'Describe a good habit your friend has that you want to develop', 'Habits shape character — discussing good habits is a gentle, positive way to share life lessons between generations.', 10, 1, '2026-04-20 14:27:25');
...
INSERT INTO `topic` VALUES ('ob-old-thing', 'cat-object', 'A Family Heirloom', 'Describe an important old thing your family has kept', 'Family heirlooms are living stories — every item holds history that bridges the gap between generations.', 5, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-overspend', 'cat-object', 'An Unexpected Expense', 'Describe an item on which you spent more than expected', 'Money habits differ greatly across generations — this topic opens honest conversations about spending, saving and values.', 16, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-science', 'cat-object', 'A Science Subject', 'Describe an area of science you are interested in', 'Science curiosity is ageless — exploring what each generation found fascinating reveals how knowledge and wonder evolve.', 4, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-story', 'cat-object', 'A Traditional Story', 'Describe an interesting traditional story', 'Traditional stories carry cultural values — comparing stories across generations reveals how values are passed down.', 6, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-talent', 'cat-object', 'A Talent to Improve', 'Describe a natural talent (sports, music…) you want to develop', 'Talking about talent and potential connects generations through shared dreams and experiences of growth.', 7, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-technology', 'cat-object', 'A Cool Technology', 'Describe a piece of technology (not a phone) you would like to own', 'Technology has transformed daily life across generations — comparing past and present tech is always eye-opening.', 13, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-toy', 'cat-object', 'A Childhood Toy', 'Describe a toy you liked in your childhood', 'Toys are portals to childhood — sharing toy memories often brings laughter and reveals the values of each era.', 2, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-water-sport', 'cat-object', 'A Water Sport', 'Describe a water sport you would like to try', 'Sports and water evoke summer memories and physical adventures — great for sharing playful childhood experiences.', 11, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('ob-wild-animal', 'cat-object', 'A Wild Animal', 'Describe a wild animal you want to learn more about', 'Wildlife and nature connect us to the bigger world — this topic sparks conversations about values, environment and childhood wonder.', 8, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('p-creative-person', 'cat-people', 'A Creative Person', 'Describe a creative person (artist, musician, architect…) you admire', 'Creativity means different things to different generations — this topic sparks rich discussion on art, inspiration and expression.', 3, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('p-drawing-friend', 'cat-people', 'A Friend Who Loves Drawing', 'Describe a friend who loves drawing or painting', 'Art and drawing connect generations — sharing memories of drawing as a child often brings out touching stories.', 8, 1, '2026-04-20 14:27:25');
...
INSERT INTO `topic` VALUES ('p-good-friend', 'cat-people', 'An Important Friend', 'Describe a good friend who is important to you', 'Friendship looks very different across generations — this topic bridges the gap between childhood bonds and adult relationships.', 4, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('p-helpful-person', 'cat-people', 'A Helpful Person', 'Describe a person who often helps others', 'Stories about helping others are universal and cross all generations — this topic builds warmth and appreciation.', 10, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('p-music-friend', 'cat-people', 'A Friend Who Loves Music', 'Describe a friend who is good at singing or music', 'Music preferences reveal generational gaps beautifully — this topic often leads to fun comparisons and shared memories.', 5, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('p-nature-person', 'cat-people', 'Someone Who Loves Nature', 'Describe a person who encouraged you to protect nature', 'Environmental values are often passed between generations — this topic encourages reflection on our shared responsibilities.', 9, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('p-planner', 'cat-people', 'A Great Planner', 'Describe a person who is good at planning', 'Planning habits differ greatly between generations — this topic opens up honest conversations about life decisions and the future.', 7, 1, '2026-04-20 14:27:25');
...
INSERT INTO `topic` VALUES ('pl-natural', 'cat-place', 'A Natural Place', 'Describe a natural place (park, mountain…) you enjoy', 'Natural places mean different things to different generations — sharing these memories builds mutual understanding.', 2, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('pl-no-phone', 'cat-place', 'No-Phone Moments', 'Describe an occasion when you were not allowed to use your phone', 'Mobile phone usage is a hot topic between generations — this leads to fascinating and sometimes funny debates.', 3, 1, '2026-04-20 14:27:25');
...
INSERT INTO `topic` VALUES ('pl-trees', 'cat-place', 'A Place Full of Trees', 'Describe a place with many trees you\'d like to visit', 'Nature and green spaces evoke nostalgia and wonder across ages — a great way to share childhood memories of the outdoors.', 1, 1, '2026-04-20 14:27:25');
INSERT INTO `topic` VALUES ('t-childhood-food', 's1', 'Taste of Childhood', 'Food memories across generations', 'Food is the most natural conversation starter at the table. Childhood flavours trigger powerful emotions and memories — and comparing eating habits across generations reveals fascinating differences.', 1, 1, '2026-04-20 14:27:25');
...
CREATE TABLE `topic_chat_message`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL COMMENT 'H5用户；演示游客为1',
  `room_key` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '共享聊天室 key',
  `scenario_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '路由场景 id，如 s1、custom-1',
  `topic_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '话题 id，内置或自定义',
  `sender_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'me | family',
  `member_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'sender=family 时对应 family_member.id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '话题下家庭对话消息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of topic_chat_message
-- ----------------------------
INSERT INTO `topic_chat_message` VALUES (1, 1, '1', 's1', 't-food-habit', 'family', 'm1', 'Grandma', 'I still remember when you were little — you would not touch anything green!', '2026-04-23 15:52:13');
...
CREATE TABLE `topic_question`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_topic_id`(`topic_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 310 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '话题问题' ROW_FORMAT = Dynamic;
...
INSERT INTO `topic_question` VALUES (83, 'p-helpful-person', 'opening', 'Who should people ask for help — colleagues or family members?', 3);
...
INSERT INTO `topic_question` VALUES (107, 'ob-invention', 'deep', 'Who should support inventors — governments or private companies?', 3);
...
INSERT INTO `topic_question` VALUES (225, 'ev-positive-change', 'deep', 'Who makes changes more often — young people or older people?', 2);
...
INSERT INTO `topic_question` VALUES (234, 'ev-speech', 'opening', 'Which one is better — being a communicator or a listener?', 2);
...
INSERT INTO `topic_question` VALUES (246, 'ev-waiting', 'opening', 'Who behaves better when waiting — children or adults?', 2);
...
INSERT INTO `topic_question` VALUES (250, 'ev-waiting', 'deep', 'Where do children learn to be patient — at home or at school?', 3);
...
INSERT INTO `topic_question` VALUES (262, 'ev-foreign-language', 'opening', 'Which skill is more important — speaking or writing?', 2);
...
INSERT INTO `topic_question` VALUES (293, 'ev-vehicle-trip', 'opening', 'Which form of vehicle is more popular in your country — bikes, cars or motorcycles?', 1);
